    ...
    <div className='py-12 px-16'>
        <div className="max-w-7xl my-0 mx-auto flex flex-col md:flex-row md:justify-between  gap-12">
            <div className="flex flex-col items-start gap-8 text-left md:basis-1/2">
                <h2 className="text-4xl lg:text-5xl font-extralight md:pr-12">Nos asociamos con las universidades líderes del mundo</h2>
                <p className='leading-loose lg:text-lg'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel qui temporibus aperiam ratione reiciendis velit nobis voluptatem beatae ipsa quisquam illum at, facilis, cum vero maxime veniam perspiciatis, mollitia aut.</p>
                <button className='lg:text-2xl lg:py-4'>ver más</button>
            </div>
