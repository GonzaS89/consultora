...
export const Portada = () => {
    return (
        <div className='flex justify-center bg-gris'>
            <div className='max-w-7xl md:flex flex-row md:justify-between my-0 mx-auto px-8 md:px-16 relative'>
            <div className='flex flex-col items-start md:justify-between md:w-1/2 gap-6 py-8'>
                <h1 className='uppercase text-4xl lg:text-5xl font-bold text-left lg:pr-12'>Consultoría empresarial global para un mundo dinámico
                </h1>
