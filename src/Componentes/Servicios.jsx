  ...
  return (
    <div className='flex flex-col py-12 px-10'>
        ...
        <div className='flex flex-col gap-8'>
            <h2 className='text-4xl'>¿En qué podemos ayudarte?</h2>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis perspiciatis beatae est officiis natus quisquam tempore! Expedita fuga, recusandae tenetur repellendus placeat tempora voluptas eius facere inventore voluptatibus, quis ut!</p>
        </div>
